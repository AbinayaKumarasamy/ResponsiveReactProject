...
const PeopleDevelpmentPlatform = () => {
  ...
  >
    <div className="max-w-7xl mx-auto text-center bg-black bg-opacity-50 p-8 rounded-lg">
      <h1 className="text-4xl font-bold mb-4">People Development Software To Engage and Grow Your Team</h1>
      <p className="text-lg mb-6">
        Drive professional growth and organizational success by aligning employee training to your strategy
      </p>
      <p className="text-lg mb-6">
        Personalized Employee Training & Development | Performance Management | Course Administration | Dashboards
      </p>
      <div className="flex justify-center">
        <button className="bg-teal-500 text-white px-6 py-3 rounded-lg mr-4">SCHEDULE A DEMO</button>
        <button className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-lg">WATCH VIDEO</button>
      </div>
    </div>
  </div>
  <div className="max-w-7xl mx-auto text-center mt-8">
    <h2 className="text-3xl font-bold mb-4">Corporate training solutions that make your workforce future-ready by closing skill gaps</h2>
  </div>
