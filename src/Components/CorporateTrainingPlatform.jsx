...
const CorporateTrainingPlatform = () => {
  useEffect (() => {
    window.scrollTo(0,0);
    },[]);
  ...
  >
    <div className="max-w-7xl mx-auto text-center bg-black bg-opacity-50 p-8 rounded-lg">
      <h1 className="text-4xl font-bold mb-4">Corporate Training Solutions To Upskill and Retain Your Workforce</h1>
      <p className="text-lg mb-6">
        Corporate training Platform that align to your business needs and deliver effective skill development to your employees
      </p>
      <p className="text-lg mb-6">
        LMS for Corporate Training | Personalized Employee Training & Development | Performance Management | Course Administration | Dashboards
      </p>
      <button className="bg-teal-500 text-white px-6 py-3 rounded-lg">SCHEDULE A DEMO</button>
    </div>
  </div>
  <div className="max-w-7xl mx-auto text-center mt-8">
    <h2 className="text-3xl font-bold mb-4">Corporate training solutions that makes your workforce future-ready by closing skill gaps</h2>
  </div>
  <div className="max-w-7xl mx-auto mt-8 flex flex-col lg:flex-row">
    ...
    <div className="w-full lg:w-1/2 p-4">
      <img src={exampleImage} alt="example image" className="rounded-lg"/>
    </div>
  </div>
</div>
  ...
  <div className="max-w-7xl mx-auto text-center px-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      <div className="bg-blue-800 p-8 rounded-lg flex flex-col sm:flex-row items-center">
...
export default CorporateTrainingPlatform;
